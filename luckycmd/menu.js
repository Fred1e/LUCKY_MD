...
ezra({ nomCom: "cmd", aliases: ["liste", "helplist", "commandlist"], categorie: "Menu" }, async (message, client, config) => {
...
`;
    ...
    for (const category of sortedCategories) {
        ...
        for (const command of sortedCommands) {
            commandsList += `\n✳️ ${commandIndex++}. ${toFancyLowercaseFont(command)}`;
    }

    commandsList += readMore + "\n> lucky md made by frediezra tz\n";
