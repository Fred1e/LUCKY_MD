...
adams({
  ...
  if (!arg[0] || arg === "") {
    repondre("Give me a query.\n*Example: .google What is a Technology.*");
    return;
  }
...
adams({
  ...
  try {
    ...
    let imdbInfo = "Tap on the link to join movie channel on WhatsApp for updates there : https://whatsapp.com/channel/0029VaihcQv84Om8LP59fO3f\n";
    imdbInfo += " ``` LUCKY_MD FILMS```\n";
    imdbInfo += "*Made by FredieTech*\n";
    imdbInfo += "🎬Title    : " + imdbData.Title + "\n";
    imdbInfo += "📅year      : " + imdbData.Year + "\n";
    imdbInfo += "⭐Assessment : " + imdbData.Rated + "\n";
    imdbInfo += "📆Release    : " + imdbData.Released + "\n";
