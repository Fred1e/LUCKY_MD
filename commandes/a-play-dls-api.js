  ...
  try {
    ...
    if (video) {
      ...
      if (response && response.status && response.data) {
        ...
        const infoMess = {
          image: { url: picture },
          caption: `*LUCKY_MD SONG PLAYER*\n\n╭───────────────◆\n│⿻ *Title:* ${title}\n│⿻ *Author:* ${author}\n│⿻ *Published:* ${published}\n╰────────────────◆\n⦿ *Direct YtLink:* ${videoUrl}\n\n╭────────────────◆\n│ *_Powered by ©Fredi Ezra._*\n╰─────────────────◆`,
          contextInfo: {
            externalAdReply: {
              title: "LUCKY_MD SONG PLAYER",
