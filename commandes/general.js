...
zokou({ nomCom: "owner", categorie: "luckymd-devs", reaction: "🚜" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "dev", categorie: "luckymd-devs", reaction: "🚜" }, async (dest, zk, commandeOptions) => {
    const { ms, mybotpic } = commandeOptions;
...
zokou({ nomCom: "support", categorie: "luckymd-devs" }, async (dest, zk, commandeOptions) => {
